...
echo "export MONGO_QUERY='{\"status\":\"active\"}'"
echo ""
echo "# Completed orders from us-west"
echo "export MONGO_COLLECTION=\"orders\""
echo "export MONGO_QUERY='{\"status\":\"completed\",\"region\":\"us-west\"}'"
echo ""
echo "# Electronics products in stock"
echo "export MONGO_COLLECTION=\"products\""
echo "export MONGO_QUERY='{\"category\":\"electronics\",\"in_stock\":true}'"
echo ""
echo "# All users (no filter)"
echo "export MONGO_COLLECTION=\"users\""
echo "export MONGO_QUERY='{}'"
